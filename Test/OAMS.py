...
class OAMS:
    ...
    Octo-Voxel Area Multi System (OAMS) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage.
    ...
    def save_to_csv_area(self, Combinations_data : Union[np.ndarray, list], Area_data : Union[np.ndarray, list]) -> None:
        """
        Save the combinations and Area values to a CSV file.
        ...
        Area_data : Union[np.ndarray, list]
            The array or list of Area values.
        """
    ...
    def process_octovoxel(self, 
        ...
        Tuple[np.ndarray, int]
            Combinations array and Area value.
        """
    ...
    def get_array_multiprocessing(self, Depth : int, Height : int, Width : int):
        ...
        try:
            ...
            if(self.Folder):
                ...
                self.save_to_csv_area(Result_combination, Area);

                return Result_combination, Area
