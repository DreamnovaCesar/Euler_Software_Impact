...
class OVC:
    ...
    Octo-Voxel Volume Multi System (OVC) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage.
    ...
    def save_to_csv_Volume(self, Combinations_data : Union[np.ndarray, list], Volume_data : Union[np.ndarray, list]) -> None:
        ...
        Volume_data : Union[np.ndarray, list]
            The array or list of Volume values.
        """
        ...
        try:
            ...
            if(_Is_list):
                ...
                Base_name = f"Combinations_And_Volume_{self.Basepath}.csv";

                print(f"Combinations_And_Volume_{self.Basepath}.csv");
    ...
    def process_octovoxel(self, 
        ...
        Tuple[np.ndarray, int]
            Combinations array and Volume value.
        """
    ...
    def get_array_multiprocessing(self, Depth : int, Height : int, Width : int):
        ...
        try:
            ...
            if(self.Folder):
                ...
                self.save_to_csv_Volume(Result_combination, Volume);

                return Result_combination, Volume
