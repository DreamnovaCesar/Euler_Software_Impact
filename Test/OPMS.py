...
class OPMS:
    ...
    Octo-Voxel Perimeter Multi System (OPMS) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage.
    ...
    def save_to_csv_perimeter(self, 
        ...
        Perimeter_data : Union[np.ndarray, list]
            The array or list of Perimeter values.
        """
    ...
    def process_octovoxel(self, 
        ...
        Tuple[np.ndarray, int]
            Combinations array and Perimeter value.
        """
    ...
    def get_array_multiprocessing(self, Depth : int, Height : int, Width : int):
        ...
        try:
            ...
            if(self.Folder):
                ...
                self.save_to_csv_perimeter(Result_combination, Perimeter);

                return Result_combination, Perimeter
