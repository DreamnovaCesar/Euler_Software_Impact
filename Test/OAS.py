...
class OVS:
    ...
    Octo-Voxel Volume System (OVS) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage. 
    ...
    ---------
    >>> File_path = "data.csv"
    >>> Handler = OVS(File_path)
    >>> Result_combinations, Result_Volume = Handler.get_array(Depth=3, Height=3, Width=3)
    """
    def __init__(self, 
                 path: str
        ) -> None:
    ...
    def save_to_csv_Volume(self, 
        ...
        # * Store the data (Combination and Volume)
            ...
            if(self.Folder):
                ...
                for i, File in enumerate(Files):
                    ...
                    if(Depth != None and Height != None and Width != None):
                        ...
                        Volume = calculate_volume(self.Arrays);
                ...
                return Combinations_all, Volume_all
                ...
                if(Depth != None and Height != None and Width != None):
                        ...
                        self.save_to_csv_Volume(Combinations_int, Volume)
