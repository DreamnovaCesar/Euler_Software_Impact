...
class OAS:
    ...
    Octo-Voxel Area System (OAS) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage. 
    ...
    ---------
    >>> File_path = "data.csv"
    >>> Handler = OAS(File_path)
    >>> Result_combinations, Result_area = Handler.get_array(Depth=3, Height=3, Width=3)
    """
    def __init__(self, 
                 path: str
        ) -> None:
    ...
    def save_to_csv_area(self, 
        ...
        # * Store the data (Combination and Area)
        ...
        try:
            ...
            if(_Is_list):
                ...
                Base_name = f"Combinations_And_Area_{self.Basepath}.csv";

                print(f"Combinations_And_Area_{self.Basepath}.csv");
            ...
            if(self.Folder):
                ...
                for i, File in enumerate(Files):
                    ...
                    if(Depth != None and Height != None and Width != None):
                        ...
                        Area = calculate_area(self.Arrays);
                ...
                self.save_to_csv_area(Combinations_all, Area_all)

                return Combinations_all, Area_all
                ...
                if(Depth != None and Height != None and Width != None):
                        ...
                        self.save_to_csv_area(Combinations_int, Area)
