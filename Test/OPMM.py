...
class OESMM:
    ...
    Octo-Voxel Enclosing Surface Multi Manage (OESMM) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage.
    ...
    """
        ...
        #Enclosing_surface = np.sum(Combinations);

        #print(f"Combinations = {Combinations_int}, Enclosing_surface = {Enclosing_surface}");
