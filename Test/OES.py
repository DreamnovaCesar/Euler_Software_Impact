...
class OES:
    ...
    Octo-Voxel Euler Simplified (OES) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage. 
    ...
    def save_to_csv_euler(self, 
        ...
        # * Store the data (Combination and Euler)
        ...
        try:
            ...
            if(self.Folder):
                ...
                if(Depth != None and Height != None and Width != None):
                        ...
                        self.save_to_csv_euler(Combinations_int, Euler)
