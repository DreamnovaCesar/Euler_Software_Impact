...
class ME:
    ...
    Matrix Euler (ME) - A class for Bit-Quads and obtaining Q_values based on the given NibbleStorage 
    ...
    def save_to_csv_euler(self, Combinations_data : np.ndarray, Euler_data : np.ndarray) -> None:
        """
