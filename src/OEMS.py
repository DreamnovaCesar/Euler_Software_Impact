...
class OEMS(OM):
    ...
    Octo-Voxel Euler Multi System (OEMS) - A class for handling Octo-Voxels and obtaining Q_values based on the given ByteStorage.
    ...
    def save_to_csv(self, 
        ...
        Euler_data : Union[np.ndarray, list]
            The array or list of Euler values.
        """
        ...
        try:
            ...
            if(_Is_list):
                ...
                Base_name = f"Combinations_And_Euler_{self.Basepath}.csv";
            ...
            print(f"Combinations and Euler values saved to {File_path} {self.__class__.__name__}");
    ...
    def get_array(self, Depth : int, Height : int, Width : int):
        ...
        try:
            ...
            if(self.Folder):
                ...
                self.save_to_csv(Result_combination, Result_euler);
