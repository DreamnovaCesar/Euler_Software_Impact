...
class OESC(DM):
    ...
    Octo-Voxel Enclosing Surface Chunks (OESC) - A performance-optimized class for handling Octo-Voxels, 
    ...
    @Timer.timer("Execution_OESC.log")
    ...
    def get_array(self, Depth : int, Height : int, Width : int):
        ...
        try:
            ...
            if(self.Folder):
                ...
                return Result_combination, Enclosing_surface, self.Descriptor          
