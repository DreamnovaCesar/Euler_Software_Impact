...
from src.Utils.ConvertionDecimalBinaryNibble import ConvertionDecimalBinaryNibble
...
class NibbleStorage:
    ...
    """
    BINARYBYTE = ConvertionDecimalBinaryNibble;
    ...
    def to_numpy_array(cls) -> np.ndarray:
        ...
        try:
            ...
            Decimal_number = int(Config.Nibble_binary, 2);
