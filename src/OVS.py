...
class OVS(DM):
    ...
    Octo-Voxel Volume System (OVS) - A class developed especially for processing Octo-Voxels that uses a simplified 
        ...
        try:
            ...
            if(self.Folder):
                ...
                if(Depth != None and Height != None and Width != None):
                        ...
                        return Combinations, Volume, self.Descriptor 
