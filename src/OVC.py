...
class OVC(DM):
    ...
    Octo-Voxel Volumen Chunks (OVC) - A performance-optimized class for handling Octo-Voxels, 
    ...
    def get_array(self, Depth : int, Height : int, Width : int):
        ...
        try:
            ...
            if(self.Folder):
                ...
                return Result_combination, Volume, self.Descriptor  
