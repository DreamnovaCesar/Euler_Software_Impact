...
class OCSS(DM):
    ...
    Octo-Voxel Contact Surface Simplified (OCSS) - A class developed especially for processing Octo-Voxels that uses a simplified 
    ...
    >>> Result_combinations, Result_contact_surface = Handler.get_array(Depth=3, Height=3, Width=3)
    """
    def __init__(self, 
                 path: str
        ) -> None:
        ...
        self.Descriptor = "Contact_Surface";
    ...
    @Timer.timer("Execution_OCSS.log")
            ...
            if(self.Folder):
                ...
                for i, File in enumerate(Files):
                    ...
                    if(Depth != None and Height != None and Width != None):
                        ...
                        Contact_surface = calculate_contact_surface(self.Arrays);
                ...
                if(Depth != None and Height != None and Width != None):
                    ...
                    return Combinations, Contact_surface, self.Descriptor
