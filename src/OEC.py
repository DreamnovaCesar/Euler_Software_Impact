...
class OEC(DM):
    ...
    Octo-Voxel Euler Chunks (OEC) - A performance-optimized class for handling Octo-Voxels, 
            ...
            if(self.Folder):
                ...
                for i, File in enumerate(Files):
                    ...
                    with multiprocessing.Pool(processes=self.Num_processes) as pool:
                        ...
                        Combinations = zip(*Data);

                        # * Return the calculated Combinations_int as a numpy array.
                        Result_combination = np.sum(Combinations, axis=0);
                        Combinations_euler = (Result_combination * Config._OUTPUT_3D_);
                ...
                return Result_combination, Euler, self.Descriptor     
