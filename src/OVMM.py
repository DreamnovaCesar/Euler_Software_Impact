...
class OVMM(DM):
    ...
    Octo-Voxel Volume Multi Manager (OVMM) - Asynchronous approaches and multiprocessing are employed in a class created
    ...
    def process_octovoxel(self, 
        ...
        print(f"Processing file... {File_path} ----------- {Volume}");

        return Combinations_int, Volume;

    @Timer.timer("Execution_OVMM.log")
    ...
    def get_array(self, Depth: int, Height: int, Width: int) -> None:
        ...
        if self.Folder:
            ...
            return Combinations_all, Volume_all, self.Descriptor 
